#include "UserTextFrame.h"

usertextframe::UTFrame::UTFrame(char id[4], std::ifstream& stream, uint32_t& byte_n) :
...
void usertextframe::UTFrame::Print(std::ofstream& stream) {
    stream << "\tUser information frame ";
